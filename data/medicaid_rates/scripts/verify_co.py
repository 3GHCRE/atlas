#!/usr/bin/env python3
"""Verify Colorado rate changes period-over-period."""
...
# Check CO rate periods
print("=" * 60)
print("COLORADO RATE PERIODS")
print("=" * 60)
...
print("\n" + "=" * 60)
print("COLORADO RATE CHANGES (Period-over-Period)")
print("=" * 60)
...
cursor.execute("""
    ...
    FROM v_rate_changes
    WHERE state = 'CO' AND prior_rate IS NOT NULL
""")
...
print(f"Current CO rates: {summary['total']}")
