#!/usr/bin/env python3
"""Load Virginia Medicaid rates into database."""
import csv
...
# Read CSV
facilities = []
with open('VA_2025-10_rates.csv', 'r', encoding='utf-8') as f:
...
print(f"Existing current VA rates: {existing['cnt']} (latest: {existing['latest']})")
...
# Summary
print("\n" + "=" * 50)
print("VIRGINIA RATE UPDATE COMPLETE")
print("=" * 50)
